		...
		return &apiv1.ResourceQuota{
			...
			Spec: apiv1.ResourceQuotaSpec{
				Hard: map[apiv1.ResourceName]resource.Quantity{
					...
					apiv1.ResourceLimitsCPU:                resource.MustParse("12"),
					apiv1.ResourceLimitsMemory:             resource.MustParse("16Gi"),
	...
	return &apiv1.ResourceQuota{
		...
		Spec: apiv1.ResourceQuotaSpec{
			Hard: map[apiv1.ResourceName]resource.Quantity{
				...
				apiv1.ResourcePods:                     resource.MustParse("20"),
				apiv1.ResourceServices:                 resource.MustParse("10"),
				apiv1.ResourceReplicationControllers:   resource.MustParse("10"),
				apiv1.ResourceQuotas:                   resource.MustParse("3"),
				apiv1.ResourceSecrets:                  resource.MustParse("20"),
				apiv1.ResourceConfigMaps:               resource.MustParse("20"),
				apiv1.ResourcePersistentVolumeClaims:   resource.MustParse("15"),
				...
				apiv1.ResourceRequestsEphemeralStorage: resource.MustParse("30Gi"),
				apiv1.ResourceLimitsCPU:                resource.MustParse("5"),
				apiv1.ResourceLimitsMemory:             resource.MustParse("8Gi"),
				apiv1.ResourceLimitsEphemeralStorage:   resource.MustParse("30Gi"),
			},
		},
	}
