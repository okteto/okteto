...
// GetDevFromAnnotation returns the dev object from the deployment annotations
func GetDevFromAnnotation(o metav1.Object, container string) (*model.Dev, error) {
	...
	return nil, errors.ErrNotDevDeployment
}

// IsAutoDestroyOnDown returns if the deployment has to be destroyed on down
func IsAutoDestroyOnDown(o metav1.Object) bool {
	autoDestroyOnDown := getAnnotation(o, model.CNDAutoDestroyOnDown)
	return autoDestroyOnDown == "true"
}
