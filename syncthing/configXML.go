...
const configXML = `<configuration version="28">
    <folder id="esall-z6asd" label="cnd" path="{{.LocalPath}}" type="sendreceive" rescanIntervalS="3600" fsWatcherEnabled="true" fsWatcherDelayS="10" ignorePerms="false" autoNormalize="true">
