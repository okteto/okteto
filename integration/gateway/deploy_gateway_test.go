...
// TestDeployGateway tests okteto deploy with Gateway API HTTPRoute
// It verifies that when using gateway mode, HTTPRoute resources are created instead of Ingress
