...
<folder id="okteto-{{ .Name }}" label="{{ .Name }}" path="/var/okteto" type="sendreceive" rescanIntervalS="60" fsWatcherEnabled="true" fsWatcherDelayS="1" ignorePerms="false" autoNormalize="true">
