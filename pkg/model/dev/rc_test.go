...
`),
			expected: &DevRC{
				Labels:      metadata.Labels{"app": "test"},
				Annotations: metadata.Annotations{"db": "mongodb"},
				Context:     "test",
				Namespace:   "test",
...
func TestDevRCAnnotations(t *testing.T) {
	var tests = []struct {
		...
		{
			name:     "not overwrite",
			dev:      &Dev{Metadata: &metadata.Metadata{Annotations: metadata.Annotations{"app": "test"}}},
			devRC:    &DevRC{},
			expected: metadata.Annotations{"app": "test"},
		},
		{
			name:     "merge",
			dev:      &Dev{Metadata: &metadata.Metadata{Annotations: metadata.Annotations{"app": "test"}}},
			devRC:    &DevRC{Annotations: metadata.Annotations{"test": "app"}},
			expected: metadata.Annotations{"app": "test", "test": "app"},
		},
		{
			name:     "overwrite",
			dev:      &Dev{Metadata: &metadata.Metadata{Annotations: metadata.Annotations{"app": "test"}}},
			devRC:    &DevRC{Annotations: metadata.Annotations{"app": "dev"}},
			expected: metadata.Annotations{"app": "dev"},
		},
	}
