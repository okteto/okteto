			...
			stack: &Stack{
				Services: map[string]*Service{
					"app": {
						...
						Labels:      metadata.Labels{"test": "ok"},
						Annotations: metadata.Annotations{"test": "ok"},
						Ports: []Port{
							{
								HostPort:      8080,
								ContainerPort: 8080,
			...
			otherStack: &Stack{
				Services: map[string]*Service{
					"app": {
						...
						EnvFiles: environment.EnvFiles{".env-test"},
						Environment: environment.Environment{
							environment.EnvVar{
								Name:  "test",
								Value: "overwrite",
						...
						Labels:      metadata.Labels{"test": "overwrite"},
						Annotations: metadata.Annotations{"test": "overwrite"},
						Ports: []Port{
							{
								HostPort:      3000,
								ContainerPort: 3000,
