	...
	tests := []struct {
	...
	}{
		{
			...
			expected: mockEvent{
				...
				props: map[string]interface{}{
					...
					"devContainerIsRunningDurationSeconds": float64(0),
					"pulledDevContainerImage":              false,
					"waitedForAwaken":                      false,
					"waitedForAwakenDurationSeconds":       float64(0),
				},
			},
		},
		{
		...
		},
		{
			...
			meta: UpMetricsMetadata{
				...
				devContainerIsRunningDuration: 1 * time.Minute,
				waitedForAwakenDuration:       1 * time.Minute,
				pulledDevContainerImage:       true,
				waitedForAwaken:               true,
			},
			expected: mockEvent{
				event:   "Up",
				success: true,
				props: map[string]interface{}{
					...
					"devContainerIsRunningDurationSeconds": float64(60),
					"errSyncInsufficientSpace":             false,
					"errSyncLostSyncthing":                 false,
					"pulledDevContainerImage":              true,
					"waitedForAwaken":                      true,
					"waitedForAwakenDurationSeconds":       float64(60),
				},
			},
		},
		{
