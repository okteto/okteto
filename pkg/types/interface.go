...
type PreviewInterface interface {
	...
	DeployPreview(ctx context.Context, name, scope, repository, branch, sourceUrl, filename, workflowID string, variables []Variable, labels []string, redeployDependencies bool) (*PreviewResponse, error)
