...
const (
	failTitle = `Okteto is ready!`

	failIcon = template.HTML(`<svg class="illustration" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 346 244">
  <g fill="none" fill-rule="evenodd">
	...
	failContent = template.HTML(`<h1>You are now logged in!</h1>
