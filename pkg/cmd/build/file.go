...
func GetDockerfile(dockerFile string, okCtx buildCtx.OktetoContextInterface) (string, error) {
...
func getTranslatedDockerFile(filename string, okCtx buildCtx.OktetoContextInterface) (string, error) {
...
func translateOktetoRegistryImage(input string, okCtx buildCtx.OktetoContextInterface) string {
