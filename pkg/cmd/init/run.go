...
func GetDevDefaultsFromImage(_ context.Context, app apps.App) (*registry.ImageConfig, error) {
...
func SetImage(_ context.Context, dev *model.Dev, language, path string) error {
