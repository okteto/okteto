...
func TestUpAutocreate(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestUpAutocreateV1", user)
	...
	require.NoError(t, e2e.DestroyPod(context.Background(), testNamespace, "app=autocreate", c))
...
func TestUpAutocreateV2(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestUpAutocreateV2", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func TestUpAutocreateV2WithBuild(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestUpAutocreateV2Build", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
