...
func TestUpWithDeploy(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestUpWithDeploy", user)
	...
	appDeployment, err := e2e.GetDeployment(context.Background(), testNamespace, model.DevCloneName("e2etest"), c)
	require.NoError(t, err)
