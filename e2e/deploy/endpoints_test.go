...
func Test_EndpointsFromOktetoManifest_InferredName(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("EndpointManifestInfer", user)
	...
	require.NotEmpty(t, e2e.GetContentFromURL(autoIngressURL, timeout))
	...
	require.NotEmpty(t, e2e.GetContentFromURL(manifestEndpointURL, timeout))
	...
	_, err = e2e.GetService(context.Background(), testNamespace, "e2etest", c)
...
func Test_EndpointsFromOktetoManifest_Name(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("EndpointsManifest", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func Test_EndpointsFromStackWith_InferredName(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TEndpointsFromStackInfer", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func Test_EndpointsFromStack_Name(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TEndpointsFromStack", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func Test_EndpointsFromStackAndManifest(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("EndpointsStackAndManif", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func Test_EndpointsFromOktetoManifest_NameOption(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("EndpointManifestNameOp", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func Test_EndpointsFromStackWith_NameOption(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TEpStackNameOpt", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
