...
func TestBuildCommandV1(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestBuildV1", user)
...
func TestBuildInferredDockerfile(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestBuildInferredDockerfile", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func TestBuildCommandV2(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestBuildV2", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func TestBuildCommandV2OnlyOneService(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestPartialBuildV2", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func TestBuildCommandV2SpecifyingServices(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestCompleteBuildV2", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func TestBuildCommandV2VolumeMounts(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestBuildVolumesV2", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
...
func TestBuildCommandV2Secrets(t *testing.T) {
	...
	testNamespace := e2e.GetTestNamespace("TestBuildSecretsV2", user)
	namespaceOpts := &commands.NamespaceOptions{
		Namespace:  testNamespace,
		OktetoHome: dir,
		Token:      token,
