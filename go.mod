...
require (
	...
	github.com/google/go-containerregistry v0.20.7 // when updating need google.golang.org/grpc 1.29
...
replace github.com/moby/buildkit => github.com/okteto/buildkit v0.0.0-20260529132615-d3ec880b151b
