...
.PHONY: integration
integration:
	go test -run ^(TestGetVersion|TestDownloadSyncthing|TestUpDeployments|TestUpStatefulset|TestDivert|TestUpAutocreate|TestUpCompose)$ github.com/okteto/okteto/integration -tags="common integration actions" --count=1 -v -timeout 45m
