...
func selectDockerfiles(ctx context.Context, cwd string) ([]string, error) {
	...
	for index < 0 {
		...
		selection, err := utils.AskForOptionsOkteto(ctx, dockerfilesItems, "Do you need to build any of the following Dockerfiles as part of your development environment?", "", -1)
