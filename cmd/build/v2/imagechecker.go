...
func newImageChecker(cfg oktetoBuilderConfigInterface, registry registryImageCheckerInterface, tagger imageTaggerInterface, svcCfg serviceContextInterface) imageChecker {
	return imageChecker{
		tagger:   tagger,
		cfg:      cfg,
		registry: registry,
