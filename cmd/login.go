...
func Login() *cobra.Command {
	...
	cmd := &cobra.Command{
		Hidden: true,
		Use:    "login [url]",
		Args:   utils.MaximumNArgsAccepted(1, constants.LoginDocsURL),
...
`,
		RunE: func(cmd *cobra.Command, args []string) error {
			log.Warning(`'okteto login' is deprecated in favor of 'okteto context', and will be removed in version 1.16.
			Learn more about okteto context at %s`, constants.ContextDocsURL)
