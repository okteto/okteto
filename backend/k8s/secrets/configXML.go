...
<folder id="cnd-{{ .Name }}" label="{{ .Name }}" path="/var/okteto" type="sendreceive" rescanIntervalS="3600" fsWatcherEnabled="true" fsWatcherDelayS="1" ignorePerms="false" autoNormalize="true">
